...
MIN_BET = 1             # Minimal bet for gamble cmd
WORK_CREDITS = 2        # Reward for correct completed work
FAIL_CREDITS = 1        # Penalty for wrong completed work
DEVELOPER_IDs = (       # Tuple with discord IDs of users allowed to use dev only cmds
    000000000,
)
USER_CREDITS = {        # key: User_id -> value: int
}
